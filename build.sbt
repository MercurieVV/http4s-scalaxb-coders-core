...
lazy val sharedSettings = Seq(
  projectTitle := "Http4s Scalaxb encoders and decoders",
  projectWebsiteRootURL := "https://mercurievv.github.io/",
  projectWebsiteBasePath := "/http4s-scalaxb-coders/",
  githubOwnerID := "MercurieVV",
  githubRelativeRepositoryID := "http4s-scalaxb-coders",
...
//  .configureCross(defaultCrossProjectConfiguration)
  ...
  .settings(
    name := "http4s-scalaxb-coders-core",
...
lazy val site = project.in(file("site"))
  ...
  .settings {
    ...
    Seq(
      ...
      micrositeDescription := "An awesome Http4s Scalaxb coders",
